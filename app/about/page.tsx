        ...
        <section className="bg-white px-6 py-20 md:px-12 md:py-28 lg:px-20 lg:py-32">
          <div className="container-wide mx-auto">
            <div className="mb-12 flex items-center gap-6 md:mb-16">
              ...
              <h2 className="shrink-0 font-display text-5xl font-semibold text-[#1A1A1A] md:text-7xl">Our Story</h2>
            </div>
        ...
        <section className="bg-white px-6 py-20 md:px-12 md:py-28 lg:px-20 lg:py-32">
          <div className="container-wide mx-auto">
            <div className="mb-16 text-center md:mb-24">
              <h2 className="font-display text-5xl font-semibold text-[#1A1A1A] md:text-7xl">Meet Our Founders</h2>
            </div>
            ...
            <div className="grid grid-cols-1 items-center gap-14 lg:grid-cols-[1fr_1fr] lg:gap-20">
              ...
              <div>
                <div className="mb-10 flex items-center gap-5">
                  <h2 className="font-display text-5xl font-semibold leading-none text-[#1A1A1A] md:text-7xl">Safety in Uncertain Times</h2>
                  <div className="h-px flex-1 bg-nusafiri-gold/70" />
                </div>
